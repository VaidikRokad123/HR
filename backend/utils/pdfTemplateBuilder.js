...
export function resolveOfferLetterAssets() {
  ...
  if (!templatePath) {
    throw new Error(
      "Missing document template at backend/company/template/temp.jpg.",
    );
  }
...
export function buildHtmlContent(data, assets) {
  ...
  const safePages = repaginateForFooterSafety(
    data.pages || [],
    data.metadata || {},
...
.page-content{box-sizing:border-box;width:100%;height:297mm;padding:45mm 25mm 32mm 25mm;position:relative;z-index:1;font-size:11pt;line-height:1.5;overflow:hidden;}
