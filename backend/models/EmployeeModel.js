...
import { DEPARTMENTS, DESIGNATIONS } from "../config/constants.js";

const EMPLOYMENT_TYPES_NEW = [
  "Full-Time",
  "Contract",
  "Intern",
  "Notice-Period",
...
const employeeSchema = new mongoose.Schema(
  {
    ...
    maritalStatus: {
      type: String,
      enum: ["Single", "Married", "Divorced", "Engaged"],
      required: true,
    },
...
employeeSchema.pre("save", function (next) {
  ...
  if (this.dob) {
    ...
    if (m < 0 || (m === 0 && today.getDate() < new Date(this.dob).getDate()))
      age--;
    this.age = age;
  }
  // Same address
